...
import("D:/OneDrive - Envirotecture Design Service/桌面/book/tidybook/data/prism1.xlsx") %>%
...
```{r, echo = F, fig.width = 7, fig.height = 5}
# col <- c("#BD3645", "#696AAD")
import("D:/OneDrive - Envirotecture Design Service/桌面/book/tidybook/data/prism2.xlsx") %>%
...
import("D:/OneDrive - Envirotecture Design Service/桌面/book/tidybook/data/prism3.xlsx") %>%
...
### 散点图
```{r}
import("D:/OneDrive - Envirotecture Design Service/桌面/book/tidybook/data/case_1/0.xlsx") %>%
...
### 折线图
```{r}
import("D:/OneDrive - Envirotecture Design Service/桌面/book/tidybook/data/case_1/1.xlsx") %>%
...
### 柱状图1
```{r}
import("D:/OneDrive - Envirotecture Design Service/桌面/book/tidybook/data/case_1/2.xlsx") %>%
...
### 柱状图2
```{r}
import("D:/OneDrive - Envirotecture Design Service/桌面/book/tidybook/data/case_1/3.xlsx") %>%
  longer_dt(Replicates, name = "group", value = "value") %>%
  summarize_dt(n = .N, sd = sd(value), mean = mean(value), by = group) %>%
  ggplot(., aes(x = group, y = mean, color = group, fill = group)) +
  geom_errorbar(aes(ymin = mean - sd / sqrt(n), ymax = mean + sd / sqrt(n)), width = 0.25, alpha = 1, size = 1, lineend = "square") +
...
### 对比柱状图
```{r}
import("D:/OneDrive - Envirotecture Design Service/桌面/book/tidybook/data/case_1/4.xlsx") %>%
...
### 生存曲线
```{r}
F <- import("D:/OneDrive - Envirotecture Design Service/桌面/book/tidybook/data/case_1/5.xlsx")
...
### 热图
```{r}
import("D:/OneDrive - Envirotecture Design Service/桌面/book/tidybook/data/case_1/6.xlsx") %>%
...
### 散点图
```{r}
import("D:/OneDrive - Envirotecture Design Service/桌面/book/tidybook/data/case_2/0.xlsx") %>%
  ggplot(., aes(x = X, y = Y)) +
...
### 折线图
```{r}
import("D:/OneDrive - Envirotecture Design Service/桌面/book/tidybook/data/case_2/1.xlsx") %>%
  longer_dt(., Day, name = "group", value = "value") %>%
...
### 柱状图1
```{r}
import("D:/OneDrive - Envirotecture Design Service/桌面/book/tidybook/data/case_2/2.xlsx") %>%
  longer_dt(., name = "group", value = "value") %>%
  summarize_dt(n = .N, sd = sd(value), mean = mean(value), by = group) %>%
...
### 对比柱状图
```{r}
import("D:/OneDrive - Envirotecture Design Service/桌面/book/tidybook/data/case_2/3.xlsx") %>%
  longer_dt(., name = "group2", value = "value") %>%
  ggplot(., aes(group2, value, color = group1, fill = group1)) +
...
### 箱线图
```{r}
import("D:/OneDrive - Envirotecture Design Service/桌面/book/tidybook/data/case_2/4.xlsx") %>%
  longer_dt(., name = "group", value = "value") %>%
...
### 生存曲线
```{r}
F <- import("D:/OneDrive - Envirotecture Design Service/桌面/book/tidybook/data/case_2/5.xlsx")
fit <- survfit(Surv(Time_Months, Status) ~ Expression, data = F)
...
### 柱状图2
```{r}
import("D:/OneDrive - Envirotecture Design Service/桌面/book/tidybook/data/case_2/6.xlsx") %>%
  longer_dt(., name = "group", value = "value") %>%
  summarize_dt(n = .N, sd = sd(value), mean = mean(value), by = group) %>%
...
### 热图
```{r}
import("D:/OneDrive - Envirotecture Design Service/桌面/book/tidybook/data/case_2/7.xlsx") %>%
  mutate_vars(2:3, scale) %>%
  longer_dt(., ID, name = "Group", value = "value") %>%
  ggplot(., aes(x = ID, y = Group)) +
  geom_tile(alpha = 1, aes(fill = value)) +
